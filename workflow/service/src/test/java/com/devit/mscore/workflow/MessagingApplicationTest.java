...
public class MessagingApplicationTest {
  ...
  @Test
  public void givenValidEvent_WhenExecuteWorkflowIsRequested_ShouldSuccess() throws ApplicationException {
    try (MockedStatic<ApplicationContext> utilities = Mockito.mockStatic(ApplicationContext.class)) {
      ...
      var createdInstance = testCreateInstance(true);
      testCompleteTask(createdInstance);
    }
  }
  ...
  private WorkflowInstance testCreateInstance(boolean success) throws RegistryException, WebClientException {
  ...
  private void testCompleteTask(WorkflowInstance createdInstance) throws WebClientException {
    var activeTask = mock(WorkflowTask.class);
