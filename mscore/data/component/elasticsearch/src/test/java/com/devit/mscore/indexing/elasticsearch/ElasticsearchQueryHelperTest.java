...
public class ElasticsearchQueryHelperTest {
    ...
    public void testCreateQuery_AttributesQuery_NestedEquals() {
        ...
        var actualValue = (JSONObject) new JSONObject(queryBuilder.toString()).query("/bool/must/0/nested/query/match/nested.attribute");
    ...
    public void testCreateQuery_AttributesQuery_NestedContains() {
        ...
        var actualNesting = (JSONObject) new JSONObject(queryBuilder.toString()).query("/bool/must/0/nested");
        assertThat(actualNesting.getString("path"), is("nested"));
        var actualValue = (JSONObject) new JSONObject(queryBuilder.toString()).query("/bool/must/0/nested/query/query_string");
    ...
    public void testCreateQuery_MultiCriteria_AttributesQuery_Nested() {
        ...
        var actualValue1 = (JSONObject) new JSONObject(queryBuilder.toString()).query("/bool/must/0/nested/query/query_string");
        ...
        var actualValue2 = (JSONObject) new JSONObject(queryBuilder.toString()).query("/bool/must/1/nested/query/match/nested.attribute2");
