...
public interface AuthenticationProvider {
     ...
     * @return principal
     */
    JSONObject verify(ApplicationContext context, String key) throws AuthenticationException;
     ...
     */
    void storeToken(ApplicationContext context, JSONObject token) throws ApplicationException;
